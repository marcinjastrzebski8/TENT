"""
This whole module is copied from QuASK.
I don't want to install the whole library as it has dependencies I can't resolve atm on mac (jaxlib)
"""
...
def calculate_frobenius_inner_product(A, B, normalized=False):
    ...
    NOTE: could I use this to test the method I use for calculating projected kernels? It involves an estimation of frob
